...
const AboutSection = ({data}) => (
    <div className="flex flex-col md:flex-row w-full">
        ...
        <div className="flex flex-col w-full  ">
            ...
            <div className="p-1 m-2 flex flex-col md:flex-row-reverse justify-center text-center bg-gray-800 rounded-lg"> 
            ...
            <div className="p-10 m-2 flex flex-col md:flex-row justify-center text-center bg-gray-800 rounded-md">

                <div className="bg-gray-500 py-14 mx-4 my-2 flex-col h-full w-full rounded-md  flex justify-center items-center">
            ...
            <div className="bg-gray-800 p-4 m-2 rounded-lg justify-center text-center">
        ...
        <div className="bg-gray-800 md:w-[60%]  flex m-2 flex-col py-10 px-10  rounded-lg">
            ...
            <div className="m-2 py-6 px-4 w-full bg-gray-500 rounded-md flex flex-col justify-center items-center">
